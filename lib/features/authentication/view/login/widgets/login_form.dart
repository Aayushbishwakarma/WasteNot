...
import 'package:authentication/features/authentication/view/signup/signup_view.dart';
import 'package:authentication/navigation_menu.dart';
    ...
    Padding(
      ...
      child: Column(
        children: [
          ...
          ///Sign In Button
          SizedBox(width: double.infinity, child: ElevatedButton(onPressed: () => Get.to (() => const NavigationMenu()), child: Text(WNTexts.signIn))),
